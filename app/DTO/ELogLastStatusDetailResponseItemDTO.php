...
class ELogLastStatusDetailResponseItemDTO extends BaseDTO {
    ...
    public static function fromArray(array $response): self {
        return new self(
            ...
            amount: (int) ($response['data']['AMOUNT'] ?? 0),
            notes: $response['data']['NOTES'] ?? '',
            last_action: $response['data']['LAST_ACTION'] ?? '',
            pos: (int) ($response['data']['POS'] ?? 0),
            data_status: (int) ($response['data']['STATUS'] ?? 0),
