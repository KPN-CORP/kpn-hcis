                ...
                <div class="row">
                    @if (auth()->check() && (auth()->user()->employee && (strtolower(auth()->user()->employee->group_company) == "downstream")))
                        <div class="col-md-4 mb-2">
                            <label class="form-label" for="jenis_tkt_dalam_kota_<?php echo $i; ?>">Transportation Type</label>
                            <div class="input-group">
                                <select class="form-select form-select-sm" name="jenis_tkt_dalam_kota[]"
                                    id="jenis_tkt_dalam_kota_<?php echo $i; ?>" onchange="filterTransportHubByType(this)">
                ...
                <div class="row">
                    <div class="col-md-12 mb-2">
                        ...
                        <textarea class="form-control" id="ket_tkt_dalam_kota_<?php echo $i; ?>" name="ket_tkt_dalam_kota[]" rows="3"
                            placeholder="This field is for adding ticket details"></textarea>
                    </div>
                </div>
                <div class="mt-2">
