    ...
    <div class="col-md-12">
        <div class="table-responsive-sm">
            ...
            <div class="alert alert-info col-md-12" role="alert">
                *In accordance with the company's policy on <strong>Long-Distance Business Travel</strong>, any unused
                cash advance must be returned to the company's cash/account no later than <strong>2 (two) days</strong>
                after the <strong>Business Travel Accountability Declaration</strong> is verified by the <strong>GA
                    department</strong>. If the employee fails to return the unused cash advance within the specified
                time, the cash advance will be <strong>deducted from the employee's salary</strong>.
            </div>
            <div class="d-flex flex-column p-2 rounded-3" style="background-color: #f8f8f8">
                <ul class="nav mb-2" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation" id="accomodation-tab-li">
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-accomodation" role="tabpanel"
                        ...
                        @include('hcis.reimbursements.businessTrip.form.cashadvancedForm.caAccommodation')
                    </div>
            ...
            <div class="col-md-12 mt-2" id="total_bt_ent" style="display:none">
                <label class="form-label">Total Business Travel Request</label>
                <div class="input-group">
                    <div class="input-group-append">
                        <span class="input-group-text">Rp</span>
                    </div>
