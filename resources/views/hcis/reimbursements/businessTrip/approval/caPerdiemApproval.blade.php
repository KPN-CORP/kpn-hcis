                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <select class="form-control select2" name="location_bt_perdiem[]"
                                ...
                                onchange="toggleOtherLocation(this, {{ $loop->index + 1 }})" disabled>
                                <option value="">Select location...</option>
                                @foreach ($locations as $location)
                            ...
                            <div id="other-location-{{ $loop->index + 1 }}" class="mt-3"
                                ...
                                <input type="text" name="other_location_bt_perdiem[]" class="form-control bg-light"
                                    placeholder="Other Location" value="{{ $perdiem['other_location'] ?? '' }}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <div class="input-group">
                                <input class="form-control form-control-sm bg-light total-days-perdiem"
                                    name="total_days_bt_perdiem[]" type="number" value="{{ $perdiem['total_days'] }}"
                                    readonly>
                                <div class="input-group-append">
                                    <span class="input-group-text">days</span>
                                </div>
            ...
            <div id="form-container-bt-perdiem-req-1" class="card-body bg-light p-2 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <select class="form-control select2" id="company_bt_perdiem_1" name="company_bt_perdiem[]" disabled>
                            <option value="">Select Company...</option>
                            @foreach ($companies as $company)
                                <option value="{{ $company->contribution_level_code }}">
                                    {{ $company->contribution_level . ' (' . $company->contribution_level_code . ')' }}
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <select class="form-control select2" name="location_bt_perdiem[]" id="location_bt_perdiem_1"
                            onchange="toggleOtherLocation(this, 1)" disabled>
                            <option value="">Select Location...</option>
                            @foreach ($locations as $location)
                                <option value="{{ $location->area }}">
                                    {{ $location->area . ' (' . $location->company_name . ')' }}
                ...
                <div class="input-group">
                    ...
                    <input class="form-control form-control-sm bg-light" name="nominal_bt_perdiem[]"
                        id="nominal_bt_perdiem_1" type="text" value="0" onchange="onNominalChange()" readonly>
                </div>
                <br>
            </div>
        </div>
