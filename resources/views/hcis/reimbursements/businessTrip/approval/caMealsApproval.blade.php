                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control bg-light" name="nominal_bt_meals[]"
                        ...
                        <div class="col-md-12 mb-2">
                            <div class="mb-2">
                                <label class="form-label">Information</label>
                                <textarea name="keterangan_bt_meals[]" class="form-control bg-light" placeholder="Write your information here ..." readonly>{{ $meals['keterangan'] }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
