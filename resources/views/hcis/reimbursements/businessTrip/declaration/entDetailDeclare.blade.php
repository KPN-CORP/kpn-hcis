...
@if (!empty($caDetail['detail_e']) && $caDetail['detail_e'][0]['type'] !== null)
    <div id="form-container-detail">
        @foreach ($caDetail['detail_e'] as $index => $detail)
            <div id="form-container-e-detail-{{ $loop->index + 1 }}" class="p-2 mb-4 rounded-3"
                ...
                <div id="form-container-e-detail-req-{{ $loop->index + 1 }}" class="card-body bg-light p-2 mb-3"
                    ...
                    <p class="fs-4 text-primary" style="font-weight: bold;">Detail Entertainment Request</p>
                    <div class="row">
                        <!-- Company Code -->
                        <div class="col-md-6">
                            <table width="100%">
                                <tr>
                                    <th width="40%">Entertainment Type</th>
                                    <td class="block">:</td>
                                    <td>
                                        @php
                                            $typeMap = [
                ...
                <div id="form-container-e-detail-dec-{{ $loop->index + 1 }}" class="card-body bg-light p-2 mb-3"
                    style="border-radius: 1%;">
