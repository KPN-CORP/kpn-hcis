...
<body>
    <h1>New Business Trip Declaration</h1>
    ...
    @if ($businessTrip->ca === 'Ya')
        ...
        @endif
        @if ($isEnt)
            <p><strong><u>Entertain Details:</u></strong></p>
            <table style="border-collapse: collapse;">
                <thead>
                    <tr>
                        <th style="border: 1px solid #ddd; padding: 8px; text-align: left;">Category</th>
                ...
                <tbody>
                    <!-- Perdiem Row -->
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 8px;">Entertain</td>
            ...
            <p><strong><u>Entertain Declaration:</u></strong></p>
            <table style="border-collapse: collapse;">
                <thead>
                    <tr>
                        <th style="border: 1px solid #ddd; padding: 8px; text-align: left;">Category</th>
