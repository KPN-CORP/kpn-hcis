...
<body>
        ...
        @if ($isCa)
            <table style="border-collapse: collapse; width: 40%; margin-top: 8px; font-size: 10px;">
                ...
                <tr style="font-weight: bold; background-color: #f5f5f5;">
                    <td style="border: 1px solid #ddd; padding: 4px; text-align: center; vertical-align: top;">Category
                        </th>
                    <td style="border: 1px solid #ddd; padding: 4px; text-align: center; vertical-align: top;">Total
                        Days
                        </th>
                    <td style="border: 1px solid #ddd; padding: 4px; text-align: center; vertical-align: top;">Amount
                        </th>
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; padding: 4px; vertical-align: top;">
                        {{ $caDetails['total_days_perdiem'] ?? 0 }} Days</td>
                    <td style="border: 1px solid #ddd; padding: 4px; vertical-align: top;">
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; padding: 4px; vertical-align: top;">
                        {{ $caDetails['total_days_accommodation'] ?? 0 }} Days</td>
                    <td style="border: 1px solid #ddd; padding: 4px; vertical-align: top;">
    ...
    @if ($businessTrip->tiket === 'Ya')
        <table style="border-collapse: collapse; width: 70%; margin-top: 8px; font-size: 10px;">
            ...
            <tr style="font-weight: bold; background-color: #f5f5f5;">
                ...
                <td style="border: 1px solid #ddd; padding: 4px; text-align: center; vertical-align: top;">Passenger
                    Name</th>
                <td style="border: 1px solid #ddd; padding: 4px; text-align: center; vertical-align: top;">Transport
                    Type</th>
                ...
                <td style="border: 1px solid #ddd; padding: 4px; text-align: center; vertical-align: top;">Ticket Type
                    </th>
                <td style="border: 1px solid #ddd; padding: 4px; text-align: center; vertical-align: top;">Departure
                    </th>
            ...
            @foreach ($ticketDetails as $index => $ticket)
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; padding: 4px; vertical-align: top;">{{ $ticket->jenis_tkt }}
                    </td>
    ...
    @if ($businessTrip->mess === 'Ya')
        <table style="border-collapse: collapse; width: 70%; margin-top: 8px; font-size: 10px;">
            ...
            <tr style="font-weight: bold; background-color: #f5f5f5;">
                ...
                <td style="border: 1px solid #ddd; padding: 4px; text-align: center; vertical-align: top;">Location Mess
                    </th>
    ...
    @if ($businessTrip->hotel === 'Ya')
        <table style="border-collapse: collapse; width: 70%; margin-top: 8px; font-size: 10px;">
            ...
            <tr style="font-weight: bold; background-color: #f5f5f5;">
                <td style="border: 1px solid #ddd; padding: 4px; text-align: center; vertical-align: top;">No</th>
                <td style="border: 1px solid #ddd; padding: 4px; text-align: center; vertical-align: top;">Hotel Name
                    </th>
                <td style="border: 1px solid #ddd; padding: 4px; text-align: center; vertical-align: top;">No. Hotel
                    </th>
            ...
            @foreach ($hotelDetails as $index => $hotel)
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; padding: 4px; vertical-align: top;">{{ $hotel->lokasi_htl }}
                    </td>
                    <td style="border: 1px solid #ddd; padding: 4px; vertical-align: top;">
