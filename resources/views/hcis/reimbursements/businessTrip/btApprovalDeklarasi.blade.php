                            ...
                            <div class="row">
                                ...
                                <div class="bg-light p-3 mt-2 mb-2 rounded">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <div class="table-responsive table-container bg-white"
                                                ...
                                                <table class="table table-hover table-sm nowrap"
                                                    id="{{ isset($caDetail['detail_meals']) && is_array($caDetail['detail_meals']) ? (array_sum(array_column($caDetail['detail_meals'], 'nominal')) > 0 ? 'mealsTable' : '') : '' }}"
                                                    ...
                                                    <tbody>
                                                        <?php $totalLainnya = 0; ?>
                                                        @if (isset($caDetail['detail_meals']) &&
                                                                is_array($caDetail['detail_meals']) &&
                                                                count($caDetail['detail_meals']) > 0)
                                                            @foreach ($caDetail['detail_meals'] as $lainnya)
                                                                <?php
                                        ...
                                        <div class="col-md-6">
                                            <h5 class="bg-primary text-white text-center p-2" style="margin-bottom: 0;">
                                                Meals (Declaration):</h5>
                                            <div class="table-responsive table-container bg-white"
                                                style="height: 300px; overflow-y: auto;">
                                                <table class="table table-hover table-sm nowrap"
                                                    id="{{ isset($declareCa['detail_meals']) && is_array($declareCa['detail_meals']) ? (array_sum(array_column($declareCa['detail_meals'], 'nominal')) > 0 ? 'mealsTableDec' : '') : '' }}"
                                                    width="100%" cellspacing="0">
                                                    <thead class="thead-light">
                                                        {{-- <tr class="bg-primary">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @if (isset($declareCa['detail_meals']) &&
                                                                is_array($declareCa['detail_meals']) &&
