...
@section('content')
    ...
    <div class="modal fade" id="approvalDecModal" tabindex="-1" aria-labelledby="approvalDecModalLabel"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                @if (isset($n))
                    <form id="approveForm" action="{{ route('admin.approve', ['id' => $n->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="d-flex flex-column align-items-start border-danger-subtle px-2 mx-2 py-2">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="d-flex flex-column align-items-start p-2">
                                        ...
                                        <div class="mb-3 w-100">
                                            ...
                                            <div class="mt-2 d-flex justify-content-start" id="l1ActionContainerDeclare">
                                                <!-- Will be populated by JavaScript -->
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 w-100">
                                            ...
                                            <div class="mt-2 d-flex justify-content-start" id="l2ActionContainerDeclare">
                                                <!-- Will be populated by JavaScript -->
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="d-flex flex-column align-items-start border-danger-subtle px-2 mx-2 py-2">
                                        ...
                                        <div class="mb-3 w-100">
                                            ...
                                            <div class="mt-2 d-flex justify-content-start" id="l1ActionContainerExtend">
                                                <!-- Will be populated by JavaScript -->
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 w-100">
                                            ...
                                            <div class="mt-2 d-flex justify-content-start" id="l2ActionContainerExtend">
                                                <!-- Will be populated by JavaScript -->
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                <div class="modal-header bg-light border-bottom-0">
                    <h5 class="modal-title" id="rejectReasonFormLabel" style="color: #333; font-weight: 600;">Rejection
                        Reason</h5>
    ...
    <div class="modal fade" id="extendConfirm" tabindex="-1" aria-labelledby="extendConfirmLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                <div class="modal-header bg-light border-bottom-0">
                    <h5 class="modal-title" id="extendConfirmLabel" style="color: #333; font-weight: 600;">Confirmation
                        Reject Extend</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                    ...
                    <div class="modal-body p-3 text-center">
                        ...
                        <div class="d-flex justify-content-center mt-3">
                            <button type="button" class="btn btn-outline-secondary rounded-pill me-2"
                                data-bs-dismiss="modal" style="min-width: 90px;">Cancel</button>
                            <button type="submit" class="btn btn-danger rounded-pill" name="action_ca_reject"
                                value="Extend Reject" style="min-width: 90px;">Reject</button>
                        </div>
                    </div>
                </form>
            </div>
