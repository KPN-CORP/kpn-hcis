            ...
            <div class="card-body">
                    ...
                    @if (auth()->check() && (auth()->user()->employee && (strtolower(auth()->user()->employee->group_company) == "downstream")))
                        <div class="col-md-4 mb-2">
                            ...
                            <div class="input-group">
                                <select class="form-select form-select-sm" name="jenis_tkt_dalam_kota[]" onchange="filterTransportHubByType(this)">
                ...
                <div class="mt-2">
                    <button type="button" class="btn btn-sm btn-outline-danger remove-ticket-btn-dalam-kota"
                        id="remove-ticket-btn-dalam-kota" data-form-id="<?php echo $i; ?>">Delete</button>
                </div>
            </div>
        </div>
        <?php endfor; ?>
    </div>
    <button type="button" class="btn btn-sm btn-primary add-ticket-btn-dalam-kota" id="add-ticket-btn-dalam-kota">Add More</button>
</div>
