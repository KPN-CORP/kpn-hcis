                    ...
                    @if (isset($declareCA['detail_meals'][$index]))
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="mb-2">
                                    <label class="form-label">Information</label>
                                    <textarea name="keterangan_bt_meals[]" class="form-control" placeholder="Write your information ..." disabled>{{ $meals_dec['keterangan'] }}</textarea>
                                </div>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="fs-5 bg-light text-primary p-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="mb-2">
                                    <label class="form-label">Information</label>
                                    <textarea name="keterangan_bt_meals[]" class="form-control" disabled>{{ $meals_dec['keterangan'] }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
