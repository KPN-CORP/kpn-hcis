    ...
    <div id="form-container-detail">
        @foreach ($caDetail['detail_e'] as $index => $detail)
            <div id="form-container-e-detail-{{ $loop->index + 1 }}" class="p-2 mb-2 bg-light card-body rounded-3">
                <p class="text-primary fs-4" style="font-weight: bold; ">Detail Entertainment {{ $loop->index + 1 }}</p>
                <div id="form-container-e-detail-req-{{ $loop->index + 1 }}" class="card-body bg-white p-2 rounded-3 mb-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <table width="100%">
                                <tr>
                                    <th class="label" width="40%">Entertainment Type</th>
                                    <td class="block">:</td>
                                    <td class="value">
                                        @php
                                            $typeMap = [
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select name="enter_type_e_detail[]" id="enter_type_e_detail[]" class="form-select">
                                    ...
                                    <option value="meeting"
                                        {{ $detail_dec['type'] == 'meeting' ? 'selected' : '' }}>Meeting</option>
                                    <option value="event"
                                        {{ $detail_dec['type'] == 'event' ? 'selected' : '' }}>Event</option>
                                </select>
                            </div>
                            <div class="col-md-6 mb-2">
            ...
            @if (!isset($caDetail['detail_e'][$index]))
                <div id="form-container-e-detail-{{ $loop->index + 1 }}" class="p-2 mb-2 bg-light card-body rounded-3">
                    <p class="fs-4 text-primary" style="font-weight: bold; ">Detail Entertainment
                        {{ $loop->index + 1 }}</p>
                    <div class="p-2 rounded-3 card-body bg-white">
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <label class="form-label">Entertainment Type</label>
                            <select name="enter_type_e_detail[]" id="enter_type_e_detail_{{ $loop->index + 1 }}"
                                ...
                                <option value="meeting" {{ $detail_dec['type'] == 'meeting' ? 'selected' : '' }}>Meeting
                                </option>
                                <option value="event" {{ $detail_dec['type'] == 'event' ? 'selected' : '' }}>Event
                                </option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-2">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            ...
                            <select name="enter_type_e_detail[]" id="enter_type_e_detail_{{ $loop->index + 1 }}"
                                ...
                                <option value="transport" {{ $detail_dec['type'] == 'transport' ? 'selected' : '' }}>
                                    Transport</option>
                                <option value="meeting" {{ $detail_dec['type'] == 'meeting' ? 'selected' : '' }}>
                                    Meeting</option>
                                <option value="event" {{ $detail_dec['type'] == 'event' ? 'selected' : '' }}>
                                    Event</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-2">
