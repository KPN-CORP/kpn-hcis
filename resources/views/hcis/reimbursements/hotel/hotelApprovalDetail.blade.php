                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg mb-2">
                                                ...
                                                <textarea class="form-control form-control-sm" name="description[]" id="description-<?php echo $i; ?>">{{ $hotel['description'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <form method="POST" action="{{ route('change.status.hotel', ['id' => $hotel['id']]) }}"
                            ...
                            <button type="button" class="btn btn-success rounded-pill approve-button"
                                style="padding: 0.5rem 1rem;" data-id="{{ $hotel['id'] }}">
                                Approve
                            </button>
                        </form>
                    </div>
    ...
    <div class="modal fade" id="revisiReasonModal" tabindex="-1" aria-labelledby="revisiReasonModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body p-4">
                    <form id="revisiReasonForm" method="POST" action="{{ route('change.status.hotel', ['id' => $hotel['id']]) }}">
                        @csrf
                        @method('PUT')
