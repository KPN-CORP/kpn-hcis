...
<div class="container mt-4">
    <div class="card shadow-sm">
        <div class="card-header" style="background-color: #AB2F2B; color:white">
            <h5 class="card-title mb-0">Ticket Revision Form</h5>
        </div>

        <div class="card-body">
            <form action="{{ route('revision.ticket', ['id' => $id, 'manager_id' => $manager_id, 'status' => $status]) }}"
                method="POST" id="revisionForm">
                @csrf
                {{-- @method('GET') --}}
                <!-- SPPD Details -->
