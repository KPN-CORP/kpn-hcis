...
<body>
    ...
    <h2>New Business Travel Declaration</h2>
    ...
    @if ($isCa == true)
        <table style="border-collapse: collapse; width: 60%; margin-top: 8px; font-size: 12px;">
            ...
            <tr style="font-weight: bold; background-color: #f5f5f5; text-align: center;">
                <td rowspan="2" style="border: 1px solid #ddd; padding: 6px; vertical-align: middle;">Category
                </td>
            ...
            <tr>
                ...
                <td style="border: 1px solid #ddd; padding: 6px; text-align: center;">
                    {{ $caDeclare['total_days_perdiem'] ?? 0 }} Days</td>
                <td style="border: 1px solid #ddd; padding: 6px;">Rp.
            ...
            @if ($group_company !== 'KPN Plantations' && $group_company !== 'Plantations')
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; padding: 6px;">Rp.
                        {{ number_format($caDetails['total_amount_meals'] ?? 0, 0, ',', '.') }}</td>
                    <td style="border: 1px solid #ddd; padding: 6px; text-align: center;">
                        {{ $caDeclare['total_days_meals'] ?? 0 }} Days</td>
                    <td style="border: 1px solid #ddd; padding: 6px;">Rp.
                        {{ number_format($caDeclare['total_amount_meals'] ?? 0, 0, ',', '.') }}</td>
                </tr>
            @endif
            <tr>
            ...
            <tr>
                ...
                <td style="border: 1px solid #ddd; padding: 6px; text-align: center;">
                    {{ $caDeclare['total_days_accommodation'] ?? 0 }} Days</td>
                <td style="border: 1px solid #ddd; padding: 6px;">Rp.
    ...
    @if ($isEnt == true)
        <table style="border-collapse: collapse; width: 50%; margin-top: 8px; font-size: 12px;">
            ...
            <tr>
                ...
                <td style="border: 1px solid #ddd; padding: 6px; text-align: center;"> - </td>
                <td style="border: 1px solid #ddd; padding: 6px;">Rp.
                    {{ number_format($entDetails['total_amount_ent'] ?? 0, 0, ',', '.') }}</td>
                <td style="border: 1px solid #ddd; padding: 6px; text-align: center;"> - </td>
                <td style="border: 1px solid #ddd; padding: 6px;">Rp.
                    {{ number_format($entDeclare['total_amount_ent'] ?? 0, 0, ',', '.') }}</td>
            </tr>
        </table>
    @endif
