            ...
            <div id="form-container-bt-transport-{{ $loop->index + 1 }}" class="card-body p-2 mb-3"
                ...
                <div id="form-container-bt-transport-req-{{ $loop->index + 1 }}" class="card-body bg-light p-2 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-2">
                            <label class="form-label">Transport Date</label>
                            <input type="date" name="tanggal_bt_transport[]" class="form-control bg-light"
                                value="{{ $transport['tanggal'] }}" placeholder="mm/dd/yyyy" readonly>
                        </div>
                        <div class="col-md-4 mb-2">
                            <label class="form-label" for="name">Company Code</label>
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control bg-light" name="nominal_bt_transport[]"
                        ...
                        <div class="col-md-12 mb-2">
                            <div class="mb-2">
                                <label class="form-label">Information</label>
                                <textarea name="keterangan_bt_transport[]" class="form-control bg-light" placeholder="Write your information here ..." readonly>{{ $transport['keterangan'] }}</textarea>
                            </div>
                        </div>
                    </div>
                    <br>
        ...
        <div id="form-container-bt-transport-1" class="card-body p-2 mb-3" style="background-color: #f8f8f8">
            ...
            <div id="form-container-bt-transport-req-1" class="card-body bg-light p-2 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                        <label class="form-label" for="name">Company Code</label>
                        <select class="form-control select2" id="company_bt_transport_1" name="company_bt_transport[]" disabled>
                            <option value="">Select Company...</option>
                            @foreach ($companies as $company)
                                <option value="{{ $company->contribution_level_code }}">
                                    {{ $company->contribution_level . ' (' . $company->contribution_level_code . ')' }}
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input class="form-control bg-light" name="nominal_bt_transport[]" id="nominal_bt_transport_1"
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="mb-2">
                            <label class="form-label">Information</label>
                            <textarea name="keterangan_bt_transport[]" class="form-control bg-light" placeholder="Write your information here ..." readonly></textarea>
                        </div>
                    </div>
                </div>
                <br>
