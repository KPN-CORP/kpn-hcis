                ...
                <div class="row">
                    <div class="col-md-8 mb-2">
                        ...
                        <div class="input-group">
                            <input class="form-control form-control-sm bg-light" name="lokasi_mess_dalam_kota[]" type="text"
                                placeholder="ex: Jakarta" value="{{ $mess['lokasi_mess'] ?? '' }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-4 mb-2">
                        <label class="form-label">Total Room</label>
                        <div class="input-group">
                            <input class="form-control form-control-sm bg-light" name="jmlkmr_mess_dalam_kota[]" type="number"
                                min="1" placeholder="ex: 1" value="{{ $mess['jmlkmr_mess'] ?? '' }}" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 mb-2">
                        ...
                        <input type="date" class="form-control form-control-sm bg-light" name="tgl_masuk_mess_dalam_kota[]"
                            id="check-in-mess-dalam-kota-<?php echo $i; ?>"
                            value="{{ $mess['tgl_masuk_mess'] ?? '' }}"
                            onchange="calculateTotalDaysMessDalamKota(<?php echo $i; ?>)" readonly>
                    </div>
                    <div class="col-md-4 mb-2">
                        <label class="form-label">Check Out Date</label>
                        <input type="date" class="form-control form-control-sm bg-light" name="tgl_keluar_mess_dalam_kota[]"
