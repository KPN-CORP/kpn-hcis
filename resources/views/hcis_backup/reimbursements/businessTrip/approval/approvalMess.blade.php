                ...
                <div class="row">
                    <div class="col-md-8 mb-2">
                        ...
                        <div class="input-group">
                            <input class="form-control form-control-sm bg-light" name="lokasi_mess[]" type="text"
                                placeholder="ex: Jakarta" value="<?php echo $mess['lokasi_mess'] ?? ''; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-4 mb-2">
                        <label class="form-label">Total Room</label>
                        <div class="input-group">
                            <input class="form-control form-control-sm bg-light" name="jmlkmr_mess[]" type="number"
                                min="1" placeholder="ex: 1" value="<?php echo $mess['jmlkmr_mess'] ?? ''; ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 mb-2">
                        ...
                        <input type="date" class="form-control form-control-sm bg-light" name="tgl_masuk_mess[]"
                            id="check-in-mess-<?php echo $i; ?>" value="<?php echo $mess['tgl_masuk_mess'] ?? ''; ?>"
                            onchange="calculateTotalDaysMess(<?php echo $i; ?>)" readonly>
                    </div>
                    <div class="col-md-4 mb-2">
                        <label class="form-label">Check Out Date</label>
                        <input type="date" class="form-control form-control-sm bg-light" name="tgl_keluar_mess[]"
